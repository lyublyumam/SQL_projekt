...
Česká republika má kompletní data pro celé sledované období 2006–2018, takže analýza vlivu HDP (otázka č. 5) není chybějícími hodnotami ovlivněna.
...
Přestože nominální ceny obou potravin vzrostly (chléb o 50 %, mléko o 37 %), mzdy rostly rychleji (56.8 %). Reálná kupní síla obyvatelstva se tak vůči těmto produktům zvýšila. Pro komplexní posouzení celkového vývoje životní úrovně bychom měli porovnat růst mezd s celkovým indexem spotřebitelských cen, který zohledňuje širší spotřební koš domácností.
...
```
  ...
  #### Výstup:
Pro přehled všech let byl WHERE filtr odstraněn:

| Rok | Růst cen (%) | Růst mezd (%) | Rozdíl (%) |
|---|---|---|---|
|2006|-|-|-|
| 2007 | 9.26 | 6.91 | 2.35 |
| 2008 | 8.92 | 7.24 | 1.68 |
...
| 2018 | 2.41 | 7.78 | -5.37 |
  ...
  #### Závěr:
V období 2006–2018 nebyl zaznamenán žádný rok, ve kterém by meziroční nárůst cen potravin převýšil růst   
mezd o více než 10 %. Hypotéza se nepotvrdila.
Největší rozdíl byl zaznamenán v roce 2013 (6.79 %), kdy ceny rostly rychleji než mzdy, což je spojeno s ekonomickými problémy tohoto roku (dozvuk finanční krize).
Naopak v roce 2009 mzdy převýšily růst cen o 9.56 %, protože ceny potravin výrazně klesly (-6.59 %) jako reakce na pokles poptávky během krize. V letech 2014–2016 a 2018 mzdy rostly rychleji než ceny, což svědčí o zlepšování životní úrovně obyvatelstva.
...
```
  ...
  #### Výstup:
| Rok | Růst cen (%) | Růst mezd (%) | Růst HDP (%) |
|---|---|---|---|
|2006|-|-|-|
| 2007 | 9.26 | 6.91 | 5.57 |
| 2008 | 8.92 | 7.24 | 2.69 |
...
| 2018 | 2.41 | 7.78 | 3.20 |
  ...
  #### Závěr:
HDP je považován za ukazatel ekonomického růstu a je ovlivněn výdaji domácností, investicemi, vládními   
výdaji a exportem. S růstem HDP se zpravidla zvyšuje i cenová hladina a mzdy.

Data tuto hypotézu částečně potvrzují. V roce 2009 s dopadem finanční krize poklesl HDP (-4.66 %), což se projevilo i poklesem cen potravin (-6.59 %). Mzdy však reagovaly se zpožděním — v roce 2009 ještě mírně rostly (2.97 %), ale pokles se projevil až v roce 2013.

V letech 2015–2017 naopak rostoucí HDP promitl do růstu mezd i cen v následujících letech, což naznačuje že vliv HDP na mzdy a ceny potravin existuje, ale projevuje se se zpožděním jednoho až dvou let.

**Metodologické omezení**: Musíme brát v úvahu, že sledované období 13 let (12 meziročních ukazatelů) je z makroekonomického hlediska krátké na jednoznačné prokázání příčinného vztahu. HDP vykazuje dlouhodobé strukturální trendy a ceny potravin i mzdy jsou ovlivňovány dalšími vnějšími faktory (např. daňovými změnami, politikou EU, monetární politikou). 
